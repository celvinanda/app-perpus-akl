                ...
                <li class="nav-item">
                    <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse-4">
                            <div class="bg-white border rounded py-2 collapse-inner">
                                <h6 class="collapse-header">E - Karya Ilmiah</h6><a class="collapse-item"
                                                                                    href="{{url('karya')}}">Daftar
                                    Karya</a><a class="collapse-item" href="{{url('karya-konfirmasi')}}">Permintaan</a>
                            </div>
                        </div>
                    </div>
                </li>
                    ...
                    <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse-3">
                            <div class="bg-white border rounded py-2 collapse-inner">
                                ...
                                <a class="collapse-item" href="{{'daftar-pengunjung'}}">Data Pengunjung</a>
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar-1">
                ...
                <li class="nav-item">
                    <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse-1">
                            <div class="bg-white border rounded py-2 collapse-inner">
                                <h6 class="collapse-header">Absensi</h6><a class="collapse-item" href="admin-kode.html">Kode
                                    Pengunjung</a><a class="collapse-item" href="admin-absensi.html">Daftar Hadir</a>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse-4">
                            <div class="bg-white border rounded py-2 collapse-inner">
                                <h6 class="collapse-header">E - Karya Ilmiah</h6><a class="collapse-item"
                                                                                    href="admin-list-karya.html">Daftar
                                    Karya</a><a class="collapse-item" href="admin-konfirmasi-karya.html">Permintaan</a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse-3">
                            <div class="bg-white border rounded py-2 collapse-inner">
                                <h6 class="collapse-header">Pengunjung</h6><a class="collapse-item"
                                                                              href="admin-user-tamu.html">Tambah
                                    Tamu</a><a class="collapse-item" href="admin-user-guru.html">Tambah Guru</a><a
                                    class="collapse-item" href="admin-user-siswa.html">Tambah Siswa</a><a
                                    class="collapse-item" href="admin-user.html">Data Pengunjung</a>
                                <h6 class="collapse-header">Admin</h6><a class="collapse-item" href="admin-add.html">Tambah
                                    Admin</a><a class="collapse-item" href="admin-list.html">Data Admin</a>
                            </div>
                        </div>
                    </div>
                    <div id="collapsePages" class="collapse" aria-labelledby="headingTwo" aria-controls="collapsePages"
                ...
                <li class="nav-item"><a class="nav-link" href="admin-galeri.html"><i class="far fa-images"></i><span>&nbsp;Galeri</span></a>
                </li>
                <li class="nav-item"><a class="nav-link" href="admin-laporan.html"><i class="fas fa-print"></i><span>&nbsp;Laporan</span></a>
                </li>
                <hr class="sidebar-divider">
            </ul>
            <hr class="sidebar-divider my-0">
